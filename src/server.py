...
# Fix 2: Prevent deadlocks on slow upstream servers
...
    extracts = []
    # Fix 1: Global Budget to prevent GAS memory exhaustion
...
            
            # Slice up to remaining global_budget instantly from User-Space Memory
